...
public interface IntSendPort extends SendPort<Integer> {
     ...
     */
    boolean send(int message, long timeout, TimeUnit unit) throws InterruptedException, TimeoutException;
     ...
     * @return {@code true} if the message has been sent successfully; {@code false} if the timeout has expired.
     */
    boolean send(int message, Timeout timeout) throws InterruptedException, TimeoutException;
