...
public interface IntReceivePort extends ReceivePort<Integer> {
     ...
     */
    int receiveInt() throws InterruptedException, EOFException;
     ...
     * @throws InterruptedException
     */
    int receiveInt(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException, EOFException;
     ...
     * @throws InterruptedException
     */
    int receiveInt(Timeout timeout) throws InterruptedException, TimeoutException, EOFException;
